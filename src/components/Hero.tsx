    ...
    <main className="bg-[#1F221A] text-neutral-950 overflow-hidden">
      ...
      >
        ...
        >
          ...
          <div ref={headerTextRef1} className="pointer-events-none absolute left-5 top-5 z-50 text-4xl sm:text-5xl permanent-marker-regular text-neutral-900 transition-colors">
            RUPAM DAS
          </div>
